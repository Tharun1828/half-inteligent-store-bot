...
@Bot.on_message((filters.document | filters.video | filters.audio | filters.photo | filters.text) & ~filters.command(["broadcast", "status"]) & ~filters.edited & ~filters.chat(Config.DB_CHANNEL))
